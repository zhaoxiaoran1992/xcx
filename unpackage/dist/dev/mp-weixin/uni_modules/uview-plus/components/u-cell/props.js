...
const props = {
  props: {
    ...
    iconStyle: {
      type: [Object, String],
      default: () => {
        return common_vendor.index.$u.props.cell.iconStyle;
      }
    },
    // 右侧箭头图标的样式
    rightIconStyle: {
      type: [Object, String],
      default: () => {
        return common_vendor.index.$u.props.cell.rightIconStyle;
      }
    },
    // 标题的样式
    titleStyle: {
      type: [Object, String],
      default: () => {
        return common_vendor.index.$u.props.cell.titleStyle;
      }
    },
    // 单位元的大小，可选值为large
    size: {
